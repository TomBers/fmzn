defmodule FmznWeb.ProductControllerTest do
  use FmznWeb.ConnCase

  alias Fmzn.Resources

  @create_attrs %{description: "some description", discount: 120.5, img: "some img", price: 120.5, title: "some title"}
  ...
  def fixture(:product) do
    {:ok, product} = Resources.create_product(@create_attrs)
    product
  end
